...
// 
// const isFunction = (maybeFunction: any) => typeof maybeFunction === 'function';
// 
...
// };
// 
// export default function exec(action: string, maybeBuffer: Buffer | undefined, maybeOptions: any, maybeCallback: any) {
...
//   const lastParams: ExConcatArray<string> = [] as Array<string>;
...
//   const outResult: any[] | readonly Uint8Array[] = [];
//   let outLength = 0;
//   const errResult: any[] | readonly Uint8Array[] = [];
//   let errLength = 0;
// 
